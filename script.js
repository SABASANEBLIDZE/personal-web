...
const translations = {
  ...
  en: {
    ...
    projects: {
      ...
      project4: { title: 'Delivery Website', body: 'A delivery platform concept with account flow, live support, checkout, tracking, and filtering, designed to feel fast, structured, and easy to use across screens.', alt: 'Delivery Website' },
      project5: { title: 'Website Template System', body: 'A reusable website starter system designed for faster launches, consistent sections, and clean front-end customization.', alt: 'Website template preview' },
    },
    process: {
      kicker: 'Process',
  ...
  ka: {
    ...
    projects: {
      ...
      project4: { title: 'Delivery Website', body: 'მიტანის პლატფორმის კონცეფცია account flow-ით, live support-ით, checkout-ით, tracking-ით და filtering-ით, შექმნილი სწრაფი, სტრუქტურირებული და ყველა ეკრანზე მარტივად გამოსაყენებელი გამოცდილებისთვის.', alt: 'მიტანის ვებსაიტის პრევიუ' },
      project5: { title: 'ვებსაიტის შაბლონის სისტემა', body: 'მრავალჯერადი გამოყენების starter სისტემა, შექმნილი უფრო სწრაფი launch-ებისთვის, თანმიმდევრული სექციებისთვის და სუფთა front-end კონფიგურაციისთვის.', alt: 'ვებსაიტის შაბლონის პრევიუ' },
    },
    process: {
      kicker: 'პროცესი',
